"""
Django settings for ferroticProject project.
...
SECRET_KEY = 'django-insecure-$ck(%gy=*$kich)8206+jcgrkt_no=1_(n%stljaytmvo$!nx&'
...
WSGI_APPLICATION = 'ferroticProject.wsgi.application'
